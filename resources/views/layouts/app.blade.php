...
<body class="bg-blue-50/50 antialiased text-zinc-800 selection:bg-blue-200 selection:text-blue-900">
        ...
        <nav class="bg-white/70 backdrop-blur-2xl border border-zinc-200/50 shadow-xl shadow-zinc-200/40 rounded-full px-2 py-2 flex justify-between items-center transition-all duration-300">
            ...
            <div class="flex-shrink-0 flex items-center pl-4 sm:pl-5 hover:scale-105 transition-transform duration-300">
                <a href="{{ route('home') }}" class="flex items-center gap-2">
                    <div class="text-xs w-8 h-8 bg-blue-600 rounded-xl flex items-center justify-center text-white font-bold">
                        EvT
                    </div>
                    <span class="font-extrabold text-xl md:text-2xl tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-blue-800 to-cyan-700">
                        Eventama
                    </span>
                </a>
            </div>
            ...
            <div class="flex items-center gap-3 pr-1">
                ...
                <div class="md:hidden flex items-center pr-2">
                    <button id="mobile-menu-btn" class="text-zinc-600 hover:text-blue-600 focus:outline-none p-2 rounded-full hover:bg-zinc-100 transition">
    ...
    <footer class="bg-slate-900 border-t border-slate-800 text-slate-400 py-10 md:py-12 mt-0 md:mt-8 text-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-x-6 gap-y-10 lg:gap-12 mb-12">
                ...
                <div class="col-span-2 md:col-span-4 lg:col-span-2">
                    <a href="{{ route('home') }}" class="flex items-center gap-2 mb-6">
                        <div class="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center font-black text-white text-xs">
                            EvT
                        </div>
                        <span class="text-xl font-bold text-white tracking-tight">Event<span class="text-blue-400">ama</span></span>
                    </a>
                    
                    <div class="flex flex-nowrap lg:flex-col gap-6 lg:gap-5 overflow-x-auto pb-2 lg:pb-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                        <div class="flex items-start gap-2 sm:gap-3 shrink-0">
                            <i class="fas fa-comment-dots text-blue-400 text-base sm:text-lg mt-0.5 w-4 sm:w-5 text-center shrink-0"></i>
                            <div>
                        ...
                        <div class="flex items-start gap-2 sm:gap-3 shrink-0">
                            <i class="fas fa-envelope text-blue-400 text-base sm:text-lg mt-0.5 w-4 sm:w-5 text-center shrink-0"></i>
                            <div>
                                <p class="font-bold text-white text-xs sm:text-sm">Email</p>
                                <a href="mailto:cs@amikomevent.id" class="text-[10px] sm:text-xs text-slate-400 hover:text-blue-400 transition">
                                    cs@amikomevent.id
                                </a>
                            </div>
                        </div>
                        <div class="flex items-start gap-2 sm:gap-3 shrink-0">
                            <i class="fas fa-headset text-blue-400 text-base sm:text-lg mt-0.5 w-4 sm:w-5 text-center shrink-0"></i>
                            <div>
                                <p class="font-bold text-white text-xs sm:text-sm">Call Center</p>
                                <p class="text-[10px] sm:text-xs text-slate-500">Indonesia only<br>+62 88 200 385 9191</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-span-1 md:col-span-1 lg:col-span-1">
                    ...
                    <div class="space-y-3">
                        <a href="#" class="inline-flex w-full max-w-[144px] bg-slate-800 border border-slate-700 text-white rounded-lg px-2 py-1.5 items-center gap-2 hover:bg-slate-700 transition">
            ...
            <div class="auto-scroll-footer border-t border-dashed border-slate-700 pt-8 pb-4 lg:py-8 flex flex-nowrap lg:grid lg:grid-cols-4 gap-10 lg:gap-8 overflow-x-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                <!-- Partner -->
                ...
                <div class="shrink-0 w-auto">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <a href="#" class="w-8 h-8 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center text-slate-400 hover:text-white hover:bg-blue-600 hover:border-blue-600 transition"><i class="fab fa-facebook-f text-sm"></i></a>
                        <a href="#" class="w-8 h-8 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center text-slate-400 hover:text-white hover:bg-blue-600 hover:border-blue-600 transition"><i class="fab fa-twitter text-sm"></i></a>
                        <a href="#" class="w-8 h-8 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center text-slate-400 hover:text-white hover:bg-blue-600 hover:border-blue-600 transition"><i class="fab fa-linkedin-in text-sm"></i></a>
                        <a href="#" class="w-8 h-8 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center text-slate-400 hover:text-white hover:bg-blue-600 hover:border-blue-600 transition"><i class="fab fa-youtube text-sm"></i></a>
                        <a href="#" class="w-8 h-8 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center text-slate-400 hover:text-white hover:bg-blue-600 hover:border-blue-600 transition"><i class="fab fa-instagram text-sm"></i></a>
                    </div>
                </div>
            </div>
