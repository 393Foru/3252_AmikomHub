                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="px-8 py-6">
                                <div class="flex items-center justify-center gap-2 p-4">
                                    <button type="button" onclick="openModal('editModal{{ $partner->id }}')" class="p-2.5 bg-indigo-50 text-indigo-600 rounded-xl hover:bg-indigo-600 hover:text-white transition">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <form action="{{ route('admin.partners.destroy', $partner->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus partner ini beserta logonya?');">
                                        @csrf
                                        @method('DELETE')
