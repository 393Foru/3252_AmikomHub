                        ...
                        @if($trx->event)
                            <div class="flex items-start gap-3">
                                <div class="w-10 h-10 rounded-lg overflow-hidden shrink-0 border border-slate-100">
                                    <img src="{{ ($trx->event->poster_path) ? (\Illuminate\Support\Str::startsWith($trx->event->poster_path, 'http') ? $trx->event->poster_path : asset('storage/' . $trx->event->poster_path)) : 'https://placehold.co/160x200' }}" class="w-full h-full object-cover">
                                </div>
                                <div>
